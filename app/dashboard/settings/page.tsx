            ...
            <main className="flex-1 px-6 py-6">
              {/* <div className="flex items-center gap-4 mb-4">
                <button
                  aria-label="go-back"
                  onClick={() => router.back()}
                  className="inline-flex items-center justify-center h-10 w-10 rounded-lg border bg-background"
                >
                  ←
                </button>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid gap-2">
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Get notifications before your scheduled
                                  meetings
                                </p>
                              </div>
                            </div>
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                <Label
                                  htmlFor="meeting-changes"
                                  className="cursor-pointer"
                                >
                                  Meeting changes
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Get notified when meetings are rescheduled,
                                  canceled or updated
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="grid gap-2">
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Get notified when a task is approaching its
                                  deadline
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="grid gap-6">
                            <div className="flex justify-between items-center">
                              ...
                              <ToggleGroup type="single" defaultValue="all">
                                ...
                                <ToggleGroupItem value="important">
                                  Important
                                </ToggleGroupItem>
                            ...
                            <div className="flex justify-between items-center">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Receive push notifications in-app and on
                                  desktop
                                </p>
                              </div>
                              <ToggleGroup
                      ...
                      <CardContent className="space-y-6">
                        <div className="space-y-4">
                          ...
                          <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                              <Label htmlFor="work-hours-start">
                                Working hours
                              </Label>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid gap-2">
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                <Label
                                  htmlFor="auto-add-buffer"
                                  className="cursor-pointer"
                                >
                                  Add buffer time between meetings
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Automatically add 10 minutes of buffer time
                            ...
                            <div className="flex items-start space-x-3">
                              <Checkbox
                                id="auto-generate-agenda"
                                defaultChecked
                              />
                              <div>
                                <Label
                                  htmlFor="auto-generate-agenda"
                                  className="cursor-pointer"
                                >
                                  Auto-generate meeting agenda
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Automatically generate a meeting agenda
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              <div>
                                <Label
                                  htmlFor="add-video-conf"
                                  className="cursor-pointer"
                                >
                                  Add video conferencing by default
                                </Label>
                                <p className="text-sm text-muted-foreground">
                                  Automatically add video conferencing links to
                                  new meetings
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center p-4 border rounded-md bg-background">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    Connected · john.doe@company.com
                                  </p>
                                </div>
                              </div>
                              <Button variant="ghost" size="sm">
                  ...
                  <TabsContent value="integrations" className="mt-6 space-y-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Connect your other tools and services
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-6">
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center p-4 border rounded-md bg-background">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    Connected · Workspace: Project Docs
                                  </p>
                                </div>
                              </div>
                              <div className="flex items-center space-x-2">

  ...
  return (
    <div className="flex items-center justify-between gap-4 px-6 py-3 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-sm sticky top-0 z-30">
      <div className="flex items-center gap-3">
        <button className="rounded-md px-2 py-1 text-sm hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 6H20M4 12H20M4 18H20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <div className="flex items-center gap-1.5">
          <div className="w-7 h-7 rounded-md bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center text-white font-bold text-sm">MB</div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button className="relative rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 p-2 text-slate-600 dark:text-slate-300 transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 6.44v-2.5M12.0199 6.44c3.5168 0 6.4801 2.9633 6.4801 6.48 0 1.3201 0 2.6401 0 3.5601 0 0 0 0.96 0.48 1.44 0.4801 0.48 0.4801 0.96 0.4801 0.96 0 0.5398 -0.4402 0.96 -0.9602 0.96h-12.48c-0.5198 0 -0.96 -0.4202 -0.96 -0.96 0 0 0 -0.48 0.48 -0.96 0.48 -0.48 0.48 -1.44 0.48 -1.44 0 -0.92 0 -2.24 0 -3.5601 0 -3.5168 2.9633 -6.48 6.48 -6.48ZM13.8799 18.36v0.48c0 1.0399 -0.84 1.92 -1.8799 1.92 -1.04 0 -1.92 -0.8801 -1.92 -1.92v-0.48" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span className="absolute top-0 right-0 flex h-4 w-4 items-center justify-center rounded-full bg-teal-500 text-[10px] font-medium text-white">3</span>
          </button>
        </div>
          ...
          <DropdownMenuContent align="end" className="w-[200px]">
            <DropdownMenuLabel>
              <div className="flex flex-col space-y-0.5">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">alex.j@example.com</p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            <DropdownMenuItem>
